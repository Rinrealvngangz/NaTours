...
var showAlert = function showAlert(type, msb) {
  hideAlert();
  var markup = "<div class=\"alert alert--".concat(type, "\">").concat(msb, "</div");
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: 'http://192.168.1.249:3000/api/v1/users/logout'
            });
...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>".concat(loc.day, ": ").concat(loc.description, " </p>")).addTo(map); // extend map bounds to include current locations
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://192.168.1.249:3000/api/v1/users/updateMyPassword' : 'http://192.168.1.249:3000/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var stripe = Stripe('pk_test_51H3MswJeGfrmT98VqSB2O1mbsHScRIiG3dHGDx7azX8R196DKHcEHFeWgBQApXRu1OuhEHI7WqW364a8Z0BospFM00a2LOUxxP');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://192.168.1.249:3000/api/v1/bookings/checkout-session/".concat(tourId));
...
var loginOut = document.querySelector('.nav__el--logout');
